...
/**
 * @fileOverview Institutional Command Center v25.0.
 * HARDENED: Real-time feeds for Users and Results to prove live data synchronization.
 */
    ...
    <div className="space-y-8 md:space-y-12 pb-20 text-[#0F172A] text-left">
        ...
        <div>
           <div className="flex items-center gap-3 mb-2">
              <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-emerald-50 border border-emerald-100">
                 ...
                 <span className="text-[9px] font-black uppercase text-emerald-600 tracking-widest">System Online</span>
              </div>
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Live Registry Audit</span>
           </div>
          <h1 className="text-3xl md:text-5xl font-headline font-black text-[#0F172A] uppercase tracking-tight">Admin Center</h1>
          <p className="text-slate-500 mt-2 text-sm md:text-lg font-medium">Real-time platform metrics: {questions?.length || 0} Assets Registered.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 px-2 md:px-0">
         ...
         <Card className="lg:col-span-8 border-none shadow-3xl bg-white rounded-2xl md:rounded-[3rem] overflow-hidden text-left">
            <Tabs defaultValue="activity">
               <CardHeader className="p-6 md:p-12 border-b border-slate-50 bg-slate-50/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div>
                    <CardTitle className="text-xl md:text-2xl font-headline font-black uppercase text-[#0F172A]">Registry Audit</CardTitle>
                    <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Monitoring live student activity and content depth.</CardDescription>
                  </div>
                     ...
                     <div className="p-6 md:p-8 space-y-10">
                        ...
                        <section className="space-y-6">
                           <div className="flex items-center gap-3">
                              ...
                              <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400">Latest Student Registrations</h4>
                           </div>
                        ...
                        <section className="space-y-6">
                           <div className="flex items-center gap-3">
                              ...
                              <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400">Recent Test Audit Stream</h4>
                           </div>
                           <div className="grid grid-cols-1 gap-4">
         ...
         <div className="lg:col-span-4 space-y-8">
            <Card className="border-none shadow-3xl bg-[#0F172A] text-white p-8 md:p-10 rounded-[3rem] relative overflow-hidden group">
               ...
               <div className="relative z-10 space-y-10">
                  <div className="space-y-2">
                     <h3 className="text-2xl font-headline font-black uppercase tracking-tight">Quick Architect</h3>
                     <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Launch content generators</p>
                  </div>
                  <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-100 flex flex-col gap-6 text-left">
               <div className="flex items-center gap-4">
                  <div className="h-10 w-10 rounded-xl bg-orange-50 flex items-center justify-center text-[#F97316]">
                     <History className="h-5 w-5" />
                  </div>
                  <p className="text-[11px] font-black uppercase tracking-widest text-slate-400">Audit Logs</p>
               </div>
               <p className="text-sm font-bold text-[#0F172A] leading-relaxed uppercase">
...
function QuickLink({ label, href, icon }: any) {
   return (
      <Link href={href} className="group/link block">
         <div className="flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-2xl hover:bg-white/10 hover:border-white/10 transition-all">
            <div className="flex items-center gap-4">
               <span className="text-primary">{icon}</span>
               <span className="text-[10px] font-black uppercase tracking-widest">{label}</span>
            </div>
            <ChevronRight className="h-3 w-3 text-slate-600 group-hover/link:translate-x-1 group-hover/link:text-primary transition-all" />
         </div>
      </Link>
   )
}
