 ...
 * Updated: Storage Node capacity increased to 288TB.
 */
  ...
  return (
    <div className="space-y-12 pb-20 text-[#0F172A]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
         ...
         <HealthCard label="Storage Node" value="24.2GB / 288TB" status="STABLE" color="text-blue-600" icon={<HardDrive className="text-blue-500" />} />
