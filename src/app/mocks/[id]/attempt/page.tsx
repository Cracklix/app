...
/**
 * @fileOverview Professional CBT Engine v5.0.
 * Optimized for maximum information density and zero whitespace.
 */
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-white text-[#0F172A] font-body select-none relative">
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar relative flex flex-col">
           ...
           {examStore.isPaused && (
             <div className="absolute inset-0 z-50 bg-[#0B1528]/95 backdrop-blur-xl flex flex-col items-center justify-center p-4 animate-in fade-in duration-300">
                <div className="max-w-md w-full bg-white rounded-[3rem] shadow-5xl overflow-hidden flex flex-col">
                   ...
                   <div className="p-8 space-y-8">
                      <div className="grid grid-cols-2 gap-4">
                         ...
                         <SummaryCard label="Not Visited" val={progressStats.notVisited} color="bg-slate-50" textColor="text-slate-400" />
                      </div>
           ...
           <div className="flex-1 w-full max-w-[1200px] mx-auto p-4 md:p-6 lg:p-8 flex flex-col h-full min-h-0">
              <div className="flex-1 min-h-0">
                ...
                <div className="grid grid-cols-1 gap-2.5 mt-6 pb-6">
                   {['A', 'B', 'C', 'D'].map((key, i) => {
        ...
        <aside className="hidden lg:block w-[320px] shrink-0 border-l border-slate-200 bg-white shadow-[-4px_0_20px_rgba(0,0,0,0.02)]">
