              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                 <div className="text-left space-y-3">
                    <div className="flex items-center gap-3">
                       <div className="h-10 w-10 bg-primary/20 rounded-xl flex items-center justify-center text-primary shadow-inner"><Sparkles className="h-6 w-6" /></div>
                       <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Native Experience</p>
                    </div>
                    <h2 className="text-2xl md:text-4xl font-black uppercase">Install Cracklix App</h2>
                    <p className="text-slate-400 text-sm md:text-lg max-w-xl">Get faster access to mock tests and instant result alerts on your home screen.</p>
                 </div>
                 <Button onClick={installApp} className="w-full md:w-auto h-16 px-12 bg-white text-black hover:bg-slate-100 font-black uppercase text-[11px] tracking-widest rounded-2xl shadow-2xl border-none transition-all active:scale-95 gap-3">
