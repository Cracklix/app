        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {mocks.map((mock, i) => (
            <motion.div
              ...
              className="h-full"
            >
              <div className="bg-white rounded-3xl border p-6 hover:shadow-xl hover:-translate-y-1 transition-all group h-full flex flex-col">
                ...
                <h3 className="font-bold text-center text-base text-[#0F172A] leading-tight min-h-[48px] group-hover:text-[#F97316] transition-colors mb-4">
                  {mock.title}
                </h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-between text-[10px] text-muted-foreground uppercase font-black tracking-widest">
                     ...
                     <span className="flex items-center gap-1.5"><Clock className="h-3.5 w-3.5" /> 90m</span>
                  </div>
