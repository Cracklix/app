...
/**
 * @fileOverview Production PWA Bottom Navigation v11.0.
              ...
              <div className="flex flex-col items-center justify-center">
                <div className={cn(
                  ...
                  isActive || item.isPremium
                    ? "bg-[#2563EB] text-white shadow-lg shadow-[#2563EB]/20 w-[80px] h-[64px] rounded-[24px]" 
                ...
                <span className={cn(
                  ...
                  isActive || item.isPremium ? "text-[#2563EB]" : "text-slate-500"
                )}>
                  {item.label}
                </span>
              </div>
