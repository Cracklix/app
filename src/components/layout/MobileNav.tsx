...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[1000] bg-white border-t border-[#E2E8F0] pb-[env(safe-area-inset-bottom)] md:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.03)] pointer-events-auto h-[84px]">
      <div className="flex items-center justify-around h-full px-5 max-w-md mx-auto relative">
        {navItems.map((item) => {
