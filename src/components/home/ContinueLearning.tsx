...
/**
 * @fileOverview High-Fidelity "Continue Learning" Hub v6.0.
 * FIXED: Resolved text truncation and layout squashing on mobile/desktop.
 * STYLING: Premium dark-mode cards with high-contrast typography.
 */
               ...
               <div className="relative z-10 flex flex-row items-start md:items-center gap-5 md:gap-10">
                  ...
                  <div className="flex-1 min-w-0 space-y-4 md:space-y-6">
                     ...
                     <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-10">
                        <Button asChild className="h-11 md:h-14 px-6 md:px-8 bg-primary hover:bg-orange-600 text-white font-black uppercase text-[8px] md:text-[10px] tracking-[0.2em] rounded-xl md:rounded-2xl shadow-xl transition-all active:scale-95 border-none">
                           <Link href={`/results/${res.mockId}`}>REVIEW RESULT <ArrowRight className="ml-2 h-3 w-3" /></Link>
                        </Button>
