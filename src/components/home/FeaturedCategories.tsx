      ...
      <div className="max-w-[1440px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-16">
        ...
        <div className="space-y-2 text-left px-1">
          <div className="flex items-center gap-2 md:gap-4">
             ...
             <h2 className="text-[clamp(24px,4vw,36px)] font-black tracking-tight leading-none text-[#0F172A]">Choose Exam</h2>
          </div>
          <p className="max-w-2xl text-[clamp(13px,1.5vw,16px)] font-medium text-slate-500">Choose an exam to start your study.</p>
        </div>
            ...
            return (
              ...
              >
                 <Link href={`/exams/category/${cat.id}`} className="h-full block">
                    <Card className="border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 rounded-[24px] md:rounded-[3rem] bg-white group overflow-hidden flex flex-col p-[16px] md:p-10 lg:p-12 h-full min-h-[270px] md:min-h-[420px]">
                       <div className="flex-1 flex flex-col justify-start">
                          <div className="space-y-3 md:space-y-6">
                             ...
                             <div className="space-y-1.5 md:space-y-3">
                                <Badge className="bg-primary/5 text-primary border-none font-bold text-[clamp(11px,1vw,12px)] px-2.5 py-0.5 rounded-full shadow-sm w-fit tracking-tight">
                                   {boardLabel} Hub
                                </Badge>
                                <h3 className="text-[clamp(15px,1.8vw,20px)] font-black leading-tight text-[#0F172A] group-hover:text-primary transition-colors line-clamp-2">
                                   {cat.title}
                                </h3>
                             </div>
                          </div>
                       ...
                       <div className="mt-auto shrink-0 pt-4 md:pt-8">
                          <Button variant="ghost" className="w-full h-[48px] md:h-14 lg:h-16 rounded-full bg-[#0F172A] text-white group-hover:bg-primary transition-all font-bold text-[clamp(13px,1.1vw,14px)] tracking-tight gap-2 shadow-md border-none active:scale-95">
                             Open
