        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8 text-left">
          ...
          >
            <div className="flex items-center gap-3">
               ...
               <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Institutional Feed</span>
            </div>
          ...
          >
            Explore Exam Hubs <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-2" />
          </Link>
        </div>
          ...
          {loading ? (
            ...
            mocks.map((mock, i) => (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="border-none rounded-[3.5rem] bg-white shadow-2xl shadow-slate-200/40 hover:shadow-4xl hover:-translate-y-2 transition-all duration-700 overflow-hidden flex flex-col h-full group border border-slate-50">
                  <CardContent className="p-0 flex-1 flex flex-col h-full">
                    <div className="p-8 pb-4 space-y-8 flex-1">
                       ...
                       <div className="space-y-4">
                          <h3 className="font-bold text-base md:text-lg text-[#000000] leading-tight uppercase line-clamp-2 min-h-[48px] group-hover:text-primary transition-colors">
                           {mock.title}
                          </h3>
                          <div className="flex flex-col gap-2.5">
                             ...
                             <div className="flex items-center gap-2 text-slate-400 font-black uppercase text-[9px] tracking-widest">
                                <Award className="h-3.5 w-3.5 text-primary" /> 100% Pattern Match
                             </div>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="p-6 pt-0">
                       <Button asChild className="w-full bg-[#0B1528] hover:bg-primary text-white font-black h-12 rounded-[1.25rem] text-[9px] uppercase tracking-[0.2em] shadow-xl transition-all">
