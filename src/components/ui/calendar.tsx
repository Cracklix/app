...
/**
 * @fileOverview Production-grade Calendar node v14.0 (Hardened API Alignment).
 * FIXED: Explicitly handle all orientations to satisfy react-day-picker v9 Element type requirements.
 */
function Calendar({
  className,
  classNames,
