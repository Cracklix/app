...
/**
 * @fileOverview Production-grade Calendar node v12.2 (Type Hardened).
 * FIXED: Ensured Chevron component returns a valid JSX.Element (fragment) instead of null to satisfy TS return type.
 */
function Calendar({
  className,
  classNames,
