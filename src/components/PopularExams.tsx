...
const exams = [
  ...
  {
    name: "PSPCL & PSTCL",
    desc: "PSPCL, PSTCL & PSEB",
    exams: 8,
    mocks: 162,
  },
  {
    name: "BFUHS",
    desc: "Baba Farid University",
    exams: 4,
    mocks: 86,
  },
  {
    name: "Banking",
    desc: "Banking & Cooperative",
    exams: 10,
    mocks: 210,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {exams.map((exam, idx) => (
            ...
            >
              <Link href="/exams">
                <div className="bg-white rounded-3xl border p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group h-full flex flex-col">
