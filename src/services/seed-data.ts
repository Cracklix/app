...
/**
 * @fileOverview Institutional Seeding Engine v20.0.
 * Features: Hardened Unique Hub Registry with Verified PSSSB Assets.
 * This script ensures canonical mapping for all Punjab and National verticals.
 */
export async function seedInitialData(db: Firestore) {
  ...
  // 2. CANONICAL EXAM MASTER HUBS (Strictly Unique Verticals)
  const exams = [
    ...
    { id: 'pspcl-clerk', boardId: 'pspcl', name: 'PSPCL LDC / Clerk', category: 'TECHNICAL', description: 'Clerical recruitment for Punjab State Power Corporation.', totalFullMocks: 25, totalPyqs: 6, iconUrl: 'https://pspcl.in/assets/images/logo.png' },
